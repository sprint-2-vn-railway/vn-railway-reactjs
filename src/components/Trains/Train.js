...
const parseDate = (inputDateString) => {
...
const Train = ({ props }) => {
    ...
    return (
        <>
            <div className="border border-dark border-5 rounded rounded-5   my-5 mx-2 bg-secondary bg-opacity-50">
                <div className="d-flex justify-content-center">
                    <div className="text-center p-1 m-2 border border-dark border-3  rounded rounded-5 w-50 bg-light">
                        <div><strong>{props.trainCode}</strong></div>
                    </div>
                </div>

                <div className="container-fluid border border-start-0 border-end-0 border-dark border-5 bg-light pb-3">
